...
app.get('/karsilastir', (req, res) => res.sendFile(path.join(__dirname, 'views', 'karsilastir.html')));
app.get('/sarj-noktalari', (req, res) => res.sendFile(path.join(__dirname, 'views', 'sarj-noktalari.html')));
app.get('/haberler', (req, res) => res.sendFile(path.join(__dirname, 'views', 'haberler.html')));
